...
DETECTION_CONFIGS: Dict[DetectionType, DetectionConfig] = {
    ...
    DetectionType.ANIMAL_CATEGORY: DetectionConfig(
        ...
        class_labels=["Dog", "Cat", "Bird", "Fish", "Reptile", "Mammal", "Insect", "Amphibian", "Primate", "Other"],
        preprocessing="standard",
    ...
    DetectionType.BIOLOGICAL: DetectionConfig(
        ...
        class_labels=["Kingdom", "Phylum", "Class", "Order", "Family", "Genus", "Species"],
        preprocessing="standard",
...
class ModelRegistry:
    ...
    def __init__(self):
        ...
        logger.info(f"ModelRegistry initialized with {len(self._configs)} detection types")
