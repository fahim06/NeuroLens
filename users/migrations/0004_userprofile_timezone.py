    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('Africa/Abidjan', 'Africa/Abidjan'), ('Africa/Accra', 'Africa/Accra'),
                                            ...
                                            ('Asia/Gaza', 'Asia/Gaza'), ('Asia/Hebron', 'Asia/Hebron'),
                                            ...
                                            ('US/Pacific', 'US/Pacific'), ('UTC', 'UTC')], default='UTC',
                                   help_text='User timezone for displaying dates and times', max_length=50),
        ),
    ]
